extends CanvasLayer
## Start screen. Shows title and tap-to-start. Always starts with The Noob.
...
func _ready() -> void:
	...
	_noob_scene = preload("res://scenes/hero_noob.tscn")
	...
	# Pause the tree — nothing runs until player taps
